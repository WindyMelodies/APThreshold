...
class Ui_RampMethodWindow(object):
    def setupUi(self, RampMethodWindow):
        ...
        RampMethodWindow.setMinimumSize(QSize(0, 0))
        RampMethodWindow.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy.setHeightForWidth(self.groupBox_ramp_stimulation_method_set_paras.sizePolicy().hasHeightForWidth())
        self.groupBox_ramp_stimulation_method_set_paras.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.doubleSpinBox_precision_ramp.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_precision_ramp.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.comboBox_model_ramp.sizePolicy().hasHeightForWidth())
        self.comboBox_model_ramp.setSizePolicy(sizePolicy2)
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_k_ramp.sizePolicy().hasHeightForWidth())
        self.lineEdit_k_ramp.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.groupBox_ramp_method_simulation.sizePolicy().hasHeightForWidth())
        self.groupBox_ramp_method_simulation.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.doubleSpinBox_ramp_timeline.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_ramp_timeline.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.doubleSpinBox_dt_ramp.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_dt_ramp.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.groupBox_features_ramp.sizePolicy().hasHeightForWidth())
        self.groupBox_features_ramp.setSizePolicy(sizePolicy)
        ...
        sizePolicy3.setHeightForWidth(self.tableWidget_features_ramp.sizePolicy().hasHeightForWidth())
        self.tableWidget_features_ramp.setSizePolicy(sizePolicy3)
